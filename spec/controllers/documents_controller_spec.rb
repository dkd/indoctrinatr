...
#   let(:document_submission) { FactoryGirl.create(:document_submission) }
#   let(:valid_attributes) { { "document_submission_id" => document_submission.id } }
...
#         post :create, {:document => { "document_submission" => "invalid value" }}, valid_session
#         assigns(:document).should be_a_new(Document)
#       end
...
#         Document.any_instance.should_receive(:update).with({ "document_submission" => "" })
#         put :update, {:id => document.to_param, :document => { "document_submission" => "" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Document.any_instance.stub(:save).and_return(false)
#         put :update, {:id => document.to_param, :document => { "document_submission" => "invalid value" }}, valid_session
#         assigns(:document).should eq(document)
#       end
