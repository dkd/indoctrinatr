...
describe DocumentSubmissionsController do
  ...
  # DocumentSubmissionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new DocumentSubmission" do
        expect {
          post :create, {:document_submission => valid_attributes}, valid_session
        }.to change(DocumentSubmission, :count).by(1)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested document_submission" do
      document_submission = DocumentSubmission.create! valid_attributes
      expect {
