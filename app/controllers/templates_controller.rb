class TemplatesController < ApplicationController
  ...
  # GET /templates.json
  def index
    @templates = Template.search(params[:search]).all.page params[:page]
  end
  ...
  def template_params
    params.require(:template).permit(:name, :content, :textual_description, template_fields_attributes: [:id, :name, :label, :start_of_range, :end_of_range, :default_value, :available_options, :presentation, :_destroy])
  end
end
